...
class AgilentE3631A(AgilentSCPI):
    ...
    def __init__(
        ...
        self.setRemote()
        self.reset()
        assert "E3631A" in self.identity(), (
            "Error: improper device: " + self.identity() + "\n Expecting E3631A"
        )
        self.instruments_ = {
            "P6V": AgilentInstrument(1, "P6V", self),
            "P25V": AgilentInstrument(2, "P25V", self),
            "N25V": AgilentInstrument(3, "N25V", self),
        }
    ...
    def getSelected(self):
        ...
        assert (
            currentInstrument in self.instruments_
        ), "Error: unknown current instrument"
